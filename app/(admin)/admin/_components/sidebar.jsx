      ...
      <div className="hidden md:flex h-full flex-col overflow-y-auto bg-white shadow-sm border-r">
        ...
        <div className="flex flex-col w-full">
          {routes.map((route) => (
            <Link
              style={{
                color: pathname === route.href ? "blue" : "",
              }}
              key={route.href}
              href={route.href}
              className={`flex items-center gap-x-2 text-slate-500 text-sm font-medium pl-6 transition-all hover:text-slate-600 hover:bg-slate-100/50 h-12 ${
                pathname === route.href
