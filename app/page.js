    ...
    <div className="flex flex-col pt-20">
      ...
      <section className="relative py-16 md:py-28 dotted-background">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-5xl md:text-8xl mb-4 gradient-title font-extrabold tracking-tighter pr-2 pb-2 text-white bg-clip-text">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {featuredCars.length > 0 &&
              featuredCars.map((car, idx) => <CarCard key={idx} car={car} />)}
          </div>
        </div>
      </section>
      <section className="py-12">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {bodyTypes.map((type) => (
              ...
              >
                <div className=" rounded-lg flex  h-40 mb-4 relative">
                  <Image
